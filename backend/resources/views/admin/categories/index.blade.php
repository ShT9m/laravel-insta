...
<div class="row">
    <div class="col-7">
        <table class="table table-hover align-mmiddle gb-white border table-sm text-secondary text-center">
            ...
            @endforelse
                <tr>
                    <td></td>
                    <td class="text-dark">Uncategorized<br>
                        <span class="text-muted mb-0 xsmall">Hidden posts are not included.</span>
                    </td>
