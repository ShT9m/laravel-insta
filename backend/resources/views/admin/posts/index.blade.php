...
@section('content')
    @auth
        <div class="justify-content-end d-flex ml-auto mb-2">
            <i class="fa-solid fa-magnifying-glass text-dark"></i>&nbsp;
            <form action="{{ route('admin.posts') }}" style="width: 300px">
                <input type="search" name="search" id="search" value="{{ old('search', $search) }}" class="form-control form-control-sm" placeholder="Search...">
            </form>
        </div>
    @endauth
        ...
        @forelse ($all_posts as $post)
            <tr>
                ...
                <td>
                    ...
                    @empty
                        <span class="badge bg-dark text-wrap">Uncategorized</span>
                    @endforelse
